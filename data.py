...
class myAugmentation(object):
	...
	def __init__(self, train_path="train/image", label_path="train/label", merge_path="merge", aug_merge_path="aug_merge", aug_train_path="aug_train", aug_label_path="aug_label", img_type=ImgsType):
	...
	def doAugmentate(self, img, save_to_dir, save_prefix, batch_size=1, save_format=ImgsType, imgnum=30):
...
class dataProcess(object):
	...
	def __init__(self, out_rows, out_cols, data_path = "data/train/image", label_path = "data/train/label", test_path = "data/test/image", npy_path = "./npydata/", img_type = "bmp"):
	...
	def create_train_data(self):
		...
		for imgname in imgs:
			...
			i += 1
		print('loading done')
		np.save(self.npy_path + ImgsTrainFileName, imgdatas)
		np.save(self.npy_path + ImgsMaskTrainFileName, imglabels)
	...
	def create_test_data(self):
		...
		for imgname in imgs:
			...
			i += 1
		print('loading done')
		np.save(self.npy_path + ImgsTestFileName, imgdatas)
		print(self.npy_path)
	...
	def loadTrainData(self):
		...
		print('-'*30)
		imgs_train = np.load(self.npy_path+ImgsTrainFileName)
		imgs_mask_train = np.load(self.npy_path+ImgsMaskTrainFileName)
	...
	def loadTestData(self):
		...
		print('-'*30)
		imgs_test = np.load(self.npy_path+ImgsTestFileName)
